...
const Admincharacteristic = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await axios.delete(`http://localhost:3000/admin/characteristic/${id}`);
    ...
    const handleAddcharacteristic = async (e) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/admin/characteristic", newcharacteristic);
            console.log("Response:", response.data);
    ...
    const handleSave = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:3000/admin/characteristic/${editcharacteristic.id}`, editcharacteristic);
            console.log("Response:", response.data);
                        ...
                        <tbody>
                            {characteristic.map((characteristic, index) => (
                                <tr key={index}>
                                    ...
                                    <td>{characteristic.create_at}</td>
                                    <td>
                                        <button className="btn-navigate" onClick={() => window.location.href = "/admin/cate"}>Quản lí danh mục<FaArrowLeft /></button>                    
                                        ...
                                        <button className="btn-backpage" onClick={() => window.location.href = "/admin/typecate"}>Quản lí thể loại <FaArrowRight /></button>                    
